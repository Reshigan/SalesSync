...
test.describe('Customers CRUD E2E Tests', () => {
  ...
  test('should open create customers form', async ({ page }) => {
  ...
  test('should create new customers', async ({ page }) => {
    const createButton = page.locator('button:has-text("Add"), button:has-text("Create"), button:has-text("New"), a:has-text("Add"), a:has-text("Create"), a:has-text("New")');
  ...
  test('should view customers details', async ({ page }) => {
    await page.waitForLoadState('networkidle');
  ...
  test('should edit customers', async ({ page }) => {
    await page.waitForLoadState('networkidle');
