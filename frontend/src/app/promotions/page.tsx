...
export default function PromotionsPage() {
  ...
  const sections = [
    ...
    {
      title: 'Activities',
      description: 'Track field activities and execution',
      icon: FileCheck,
      href: '/promotions/activities',
      color: 'text-blue-600',
      bgColor: 'bg-blue-50'
    },
    {
      title: 'Materials',
      description: 'Manage promotional materials and POS',
      icon: Package,
      ...
      <div className="p-6 space-y-6">
        <div>
          ...
          <p className="mt-2 text-gray-600">
            Manage promotional campaigns, activities, materials, and customer surveys
          </p>
        </div>
