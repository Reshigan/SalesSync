...
import productDistributionRoutes from './routes/productDistribution';
...
app.use('/api/boards', authMiddleware, tenantMiddleware, boardRoutes);
app.use('/api/product-distribution', authMiddleware, tenantMiddleware, productDistributionRoutes);
app.use('/api/visits', authMiddleware, tenantMiddleware, visitRoutes);
