...
export const SurveyResponsesPage: React.FC = () => {
  ...
  useEffect(() => {
    apiClient.get('/surveys/responses').then(res => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Survey Responses</h1>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">
                {responses.length > 0
                  ? formatDuration(Math.round(responses.reduce((sum, r) => sum + r.completion_time_seconds, 0) / responses.length))
                  : '0m 0s'}
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">
                {responses.length > 0
                  ? `${(responses.reduce((sum, r) => sum + (r.score || 0), 0) / responses.length).toFixed(1)}/10`
                  : '0/10'}
              </p>
            </div>
          </div>
