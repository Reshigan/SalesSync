...
export const CustomerImportExportPage: React.FC = () => {
  ...
  const handleExport = async (format: 'csv' | 'excel' | 'pdf') => {
    try {
      const blob = await customersService.exportCustomers({}, format)
      const url = window.URL.createObjectURL(blob)
      const a = document.createElement('a')
      a.href = url
      a.download = `customers.${format === 'excel' ? 'xlsx' : format}`
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Customer Import/Export</h1>
        <p className="mt-1 text-sm text-gray-500">
          Import customers from files or export customer data
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center mb-4">
            ...
            <div className="ml-4">
              <h2 className="text-lg font-medium text-gray-900">Import Customers</h2>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className={`mt-2 text-sm ${
                      ...
                      <p>{importResults.success} customers imported successfully</p>
                      {importResults.errors.length > 0 && (
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center mb-4">
            ...
            <div className="ml-4">
              <h2 className="text-lg font-medium text-gray-900">Export Customers</h2>
              <p className="text-sm text-gray-500">Download customer data</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="border-t border-gray-100 pt-4">
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center">
                  <input type="checkbox" className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" defaultChecked />
                  <span className="ml-2 text-sm text-gray-700">Include sales data</span>
                </label>
                <label className="flex items-center">
                  <input type="checkbox" className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
                  <span className="ml-2 text-sm text-gray-700">Include credit information</span>
                </label>
              </div>
            </div>
          </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <ul className="list-disc list-inside text-sm text-blue-800 space-y-1">
          <li>Ensure your file includes all required fields: name, email, phone, address</li>
          <li>Customer codes must be unique across all customers</li>
          <li>Email addresses must be valid and unique</li>
          <li>Credit limits should be numeric values in ZAR</li>
          <li>Payment terms should be specified in days (e.g., 30, 60, 90)</li>
