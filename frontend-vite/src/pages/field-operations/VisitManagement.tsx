  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Visit Management</h1>
          ...
          <div className="bg-white rounded-lg p-4 shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-2xl font-bold text-gray-900">{stats.total_visits}</p>
              </div>
          ...
          <div className="bg-white rounded-lg p-4 shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-2xl font-bold text-gray-900">{stats.today_visits}</p>
              </div>
          ...
          <div className="bg-white rounded-lg p-4 shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-2xl font-bold text-gray-900">{stats.completed_visits}</p>
              </div>
              ...
              {loading ? (
                ...
                filteredVisits.map((visit) => (
                  <tr key={visit.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-3 sm:px-4 whitespace-nowrap text-sm text-gray-500 capitalize">
