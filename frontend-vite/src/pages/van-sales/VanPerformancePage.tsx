...
export default function VanPerformancePage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select value={filter.period} onChange={e => setFilter({...filter, period: e.target.value})} className="w-full border border-gray-200 rounded-xl px-3 py-2">
      ...
      {filter.van_id && error && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center text-red-600">
