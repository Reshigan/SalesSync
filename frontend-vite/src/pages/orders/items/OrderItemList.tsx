  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Order Items</h1>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-3 py-3 sm:px-4 text-right text-xs font-bold text-gray-600 uppercase">Discount</th>
              <th className="px-3 py-3 sm:px-4 text-right text-xs font-bold text-gray-600 uppercase">Line Total</th>
