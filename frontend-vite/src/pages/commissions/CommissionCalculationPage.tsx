...
export const CommissionCalculationPage: React.FC = () => {
  ...
  useEffect(() => {
    apiClient.get('/commissions/calculations').then(res => {
      const data = res.data?.data || res.data
      if (Array.isArray(data)) setCalculations(data)
    }).catch(() => {})
  }, [])
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Commission Calculations</h1>
