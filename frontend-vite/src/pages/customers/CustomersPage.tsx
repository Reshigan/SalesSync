      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <div className="relative">
            <button className="btn btn-secondary dropdown-toggle" onClick={() => handleExport()}>
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {stats && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          <div className="bg-[#1A1A1A] text-white rounded-3xl p-5 sm:p-6 shadow-[0_4px_24px_rgba(0,0,0,0.2)]">
            ...
            <p className="text-2xl sm:text-3xl font-bold mt-1" style={{ color: '#C0E02E' }}>{stats.total_customers}</p>
            <p className="text-sm text-gray-400 mt-1">{stats.active_customers} active</p>
          </div>

          <div className="bg-[#F8F9FA] rounded-3xl p-5 sm:p-6 shadow-card">
            <p className="text-sm font-medium text-gray-500">Total Sales</p>
            <p className="text-2xl sm:text-3xl font-bold text-gray-900 mt-1">{formatCurrency(stats.total_sales)}</p>
            <p className="text-sm text-gray-500 mt-1">All time</p>
          </div>

          <div className="bg-[#F8F9FA] rounded-3xl p-5 sm:p-6 shadow-card">
            <p className="text-sm font-medium text-gray-500">Avg Order Value</p>
            <p className="text-2xl sm:text-3xl font-bold text-gray-900 mt-1">{formatCurrency(stats.average_order_value)}</p>
            <p className="text-sm text-gray-500 mt-1">Per order</p>
          </div>

          <div className="bg-[#F8F9FA] rounded-3xl p-5 sm:p-6 shadow-card">
            <p className="text-sm font-medium text-gray-500">Customer Types</p>
            <p className="text-2xl sm:text-3xl font-bold text-gray-900 mt-1">{(stats.customers_by_type?.retail || 0) + (stats.customers_by_type?.wholesale || 0)}</p>
            <p className="text-sm text-gray-500 mt-1">{stats.customers_by_type?.retail || 0} retail, {stats.customers_by_type?.wholesale || 0} wholesale</p>
          </div>
        </div>
      )}
