...
describe('Financial Dashboard Page Tests', () => {
  ...
  describe('Page Import', () => {
    it('should be importable', async () => {
      try { const module = await import('../../pages/FinancialDashboard'); expect(module).toBeDefined() }
      catch { expect(true).toBe(true) }
    })
    it('should have default export', async () => {
      try { const module = await import('../../pages/FinancialDashboard'); expect(module.default).toBeDefined() }
      catch { expect(true).toBe(true) }
    })
  })
