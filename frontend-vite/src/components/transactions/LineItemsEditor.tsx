          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-right text-xs font-bold text-gray-600 uppercase w-20">Qty</th>
                <th className="px-4 py-3 text-right text-xs font-bold text-gray-600 uppercase w-28">Unit Price</th>
                {showCostPrice && (
                  <th className="px-4 py-3 text-right text-xs font-bold text-gray-600 uppercase w-28">Cost</th>
                )}
