-- Core tables - matches PRODUCTION D1 schema exactly (canonical source of truth)
-- Any new environment (dev/test/staging) running these migrations will get
-- the same schema as production, ensuring dev/test/live stay in sync.
