...
describe('Visits API Tests', () => {
  ...
  describe('GET /api/visits', () => {
    it('should get all visits with authentication', async () => {
    ...
    it('should fail to get visits without authentication', async () => {
  ...
  describe('POST /api/visits', () => {
    ...
    it('should fail to create visit without authentication', async () => {
      const data = {
        customerId: 1,
        agentId: 1,
        visitDate: "2024-01-01",
    ...
    it('should fail to create visit with invalid data', async () => {
      const response = await helper.getAuthRequest()
        .post('/api/visits')
        .send({});
  ...
  describe('Edge cases and error handling', () => {
    ...
    it('should handle concurrent requests', async () => {
      const promises = Array(5).fill(null).map(() =>
        helper.getAuthRequest().get('/api/visits')
      );
