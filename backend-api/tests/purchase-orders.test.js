...
describe('Purchase-orders API Tests', () => {
  ...
  describe('GET /api/purchase-orders', () => {
    it('should get all purchase-orders with authentication', async () => {
    ...
    it('should fail to get purchase-orders without authentication', async () => {
    ...
    it('should support filtering', async () => {
      const response = await helper.getAuthRequest()
        .get('/api/purchase-orders?status=active');
  ...
  describe('POST /api/purchase-orders', () => {
    it('should create purchaseOrder with valid data', async () => {
      const data = {
        supplierId: 1,
    ...
    it('should fail to create purchaseOrder without authentication', async () => {
      const data = {
        supplierId: 1,
        orderDate: "2024-01-01",
        status: "pending",
    ...
    it('should fail to create purchaseOrder with invalid data', async () => {
      const response = await helper.getAuthRequest()
        .post('/api/purchase-orders')
        .send({});
  ...
  describe('GET /api/purchase-orders/:id', () => {
    it('should get purchaseOrder by id', async () => {
      const response = await helper.getAuthRequest()
    ...
    it('should return 404 for non-existent purchaseOrder', async () => {
      const response = await helper.getAuthRequest()
    ...
    it('should handle invalid id format', async () => {
      const response = await helper.getAuthRequest()
        .get('/api/purchase-orders/invalid-id');
  ...
  describe('PUT /api/purchase-orders/:id', () => {
    it('should update purchaseOrder with valid data', async () => {
    ...
    it('should return 404 for non-existent purchaseOrder', async () => {
      const response = await helper.getAuthRequest()
        .put('/api/purchase-orders/999999')
        .send({ status: 'active' });
  ...
  describe('DELETE /api/purchase-orders/:id', () => {
    it('should delete purchaseOrder', async () => {
      const response = await helper.getAuthRequest()
    ...
    it('should return 404 for non-existent purchaseOrder', async () => {
      const response = await helper.getAuthRequest()
        .delete('/api/purchase-orders/999999');
    ...
    it('should handle invalid id format', async () => {
      const response = await helper.getAuthRequest()
        .delete('/api/purchase-orders/invalid-id');
  ...
  describe('Edge cases and error handling', () => {
    ...
    it('should handle concurrent requests', async () => {
      const promises = Array(5).fill(null).map(() =>
        helper.getAuthRequest().get('/api/purchase-orders')
      );
