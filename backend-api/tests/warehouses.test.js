...
describe('Warehouses API Tests', () => {
  ...
  describe('GET /api/warehouses', () => {
    it('should get all warehouses with authentication', async () => {
    ...
    it('should fail to get warehouses without authentication', async () => {
    ...
    it('should support search', async () => {
      const response = await helper.getAuthRequest()
        .get('/api/warehouses?search=test');
  ...
  describe('POST /api/warehouses', () => {
    ...
    it('should fail to create warehouse without authentication', async () => {
      const data = {
        name: "Test Warehouse",
        code: "WH001",
        address: "123 Warehouse St",
    ...
    it('should fail to create warehouse with invalid data', async () => {
      const response = await helper.getAuthRequest()
        .post('/api/warehouses')
        .send({});
  ...
  describe('DELETE /api/warehouses/:id', () => {
    ...
    it('should handle invalid id format', async () => {
      const response = await helper.getAuthRequest()
        .delete('/api/warehouses/invalid-id');
  ...
  describe('Edge cases and error handling', () => {
    ...
    it('should handle concurrent requests', async () => {
      const promises = Array(5).fill(null).map(() =>
        helper.getAuthRequest().get('/api/warehouses')
      );
